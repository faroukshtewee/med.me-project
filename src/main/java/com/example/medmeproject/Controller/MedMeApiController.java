...
public class MedMeApiController {
    ...
    public String searchBusinessesIdByName(@RequestParam int id, @RequestParam String token, @RequestParam String user, @RequestParam boolean skip, @RequestParam String deppartmentName, @RequestParam String workerSort, @RequestParam int networkId) throws IOException, InterruptedException {
        return medMeApiService.searchBusinessesIdByName(id, token, user, skip, deppartmentName, workerSort, networkId);
    }
    ...
    @PostMapping("/confirm")
    public String confirm(@RequestParam int id,@RequestParam String token,@RequestParam String user,@RequestParam String appointmentId,@RequestParam String clientId) throws IOException, InterruptedException{
        return medMeApiService.confirm(id, token, user, appointmentId, clientId);
    }
}